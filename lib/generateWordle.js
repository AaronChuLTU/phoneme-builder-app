 ...
 *                                       Must NOT contain the answer — it is
 *                                       shown on the page, in the browser tab
 *                                       and used for the filename.
...
<style>
  /* The activity follows the student's device preference, not the teacher's
     builder theme — the student is a different person on a different machine. */
  :root {
    color-scheme: light;
    --bg: #f6f7f9;
    --surface: #ffffff;
  ...
  * { box-sizing: border-box; }
  ...
  .key:hover:not(:disabled) { background: var(--bg); }
...
<div class="wrap">
  ...
  <div class="layout">
    ...
    <div class="panel">
      ...
      <div class="controls">
        <button class="btn" id="restart" type="button">Start again</button>
      </div>
    </div>
  </div>
</div>
